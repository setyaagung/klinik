                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        ...
                                        $qrcode = $dr->qrcode;
                                        $url = 'https://sumber-medika.herokuapp.com/surat-keterangan/'.$dr->id_darah_rutin.'/code='.$qrcode;
                                    @endphp
    ...
    <div class="darah-lengkap" style="font-size: 13px">
        <table style="width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    <td><p class="font-weight-bold" style="margin-bottom: -5px">HUTING JENIS LEUKOSIT</p>
                ...
                <tr>
                    <td>PDW</td>
                    <td class="text-center">{{ $darah_lengkap->pdw_dl}}</td>
                    <td class="text-center">
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        ...
                                        $qrcode = $dl->qrcode;
                                        $url = 'https://sumber-medika.herokuapp.com/surat-keterangan/'.$dl->id_darah_lengkap.'/code='.$qrcode;
                                    @endphp
                                    <img src="https://chart.googleapis.com/chart?cht=qr&chs=140x140&chl={{$url}}choe=UTF-8" class="mt-1">
                                </td>
                            </tr>
