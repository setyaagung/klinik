                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('doctor.create')}}" class="btn btn-primary btn-sm float-right">Tambah</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($doctors as $doctor)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('doctor.edit',$doctor->id)}}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
